...
import expo.modules.image.svg.SVGBitmapDrawableDelegate
...
class GlideRequestListener(
  ...
  override fun onResourceReady(
    ...
    val intrinsicWidth = (resource as? SVGBitmapDrawableDelegate)?.svgIntrinsicWidth ?: resource.intrinsicWidth
    val intrinsicHeight = (resource as? SVGBitmapDrawableDelegate)?.svgIntrinsicHeight ?: resource.intrinsicHeight
